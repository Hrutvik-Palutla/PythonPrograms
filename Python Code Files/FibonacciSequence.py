...
def fibseq():
    ...
    while True:
        try:
            ...
            print("Error 3 - You have entered a unrecognizable value. Please enter only a option number.")
    while fibseqtype >= 3:
        while True:
            try:
                print("Error 3 - You have entered a unrecognizable value. Please enter only a option number.")
                fibseqtype = (input("Enter the operation number as mentioned above for the operation:"))
                fibseqtype = int(fibseqtype)
                break
            except ValueError:
                print("Error 3 - You have entered a unrecognizable value. Please enter only a option number.")
    if fibseqtype == 1:
        while True:
            try:
                ...
                print("Error 2a - You have entered a unrecognizable value. Please enter only an integer.")
        while number <= 0:
        ...
        print("Error 1 - Unknown exception. A problem has occured.")
fibseq()
while True:
    try:
