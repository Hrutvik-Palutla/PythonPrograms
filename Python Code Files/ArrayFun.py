...
def createarr():
    while True:
        try:
            ...
            print("Error 2a - You have entered a unrecognizable value. Please enter only an integer value.")
    if length == 1:
        while True:
            try:
...
while selecopt >= 5:
    while True:
        try:
            print("Error 3 - You have not entered a recognizable value. Please enter only a option number.")
            selecopt = (int(input("Enter the option number as mentioned above to select it:")))
    ...
    while True:
        try:
            ...
            if adsub in ("a","A"):
                ...
                if remnum == 1:
                    ...
                    while True:
                        try:
                            ...
                            print("Error 4a - The value you have entered is not in the array.")
                            value = (int(input("Enter value to remove:")))
                elif remnum != 1:
                    remval = remnum + 1
                    value = (int(input("Enter value to remove:")))
                ...
                print("Error 5 - Invalid input. Please enter only 'a' or 'r'.")
        except Exception:
    ...
    for val in arr:
        while True:
            try:
                ...
                print("Error  - The value you entered is not a array value.")
