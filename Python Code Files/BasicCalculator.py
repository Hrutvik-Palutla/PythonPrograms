...
def calculator():
    ...
    if operation == 1:
        ...
        while True:
            try:
                num1 = (input("Enter dividend(number1):"))
                num1 = float(num1)
                break
            except ValueError:
                print("Error 2b - You have entered a unrecognizable value. Please enter only an float value.")
        while True:
            try:
                num2 = (input("Enter divisor(number2):"))
                num2 = float(num2)
                break
            except ValueError:
                print("Error 2b - You have entered a unrecognizable value. Please enter only an float value.")
        while num2 == 0:
            while True:
                try:
                    print("Error 6 - You have entered zero as the divisor. Division by zero is not defined. Please enter a valid value.")
                    num2 = (input("Enter second number:"))
                    num2 = float(num2)
                    break
                except ValueError:
