...
def exponentcalculator():
    ...
    while True:
        try:
            ...
            print("Error 19a2 - You have entered a unrecognizable value. Please enter only a function number.")
    while operation >= 3:
        while True:
            try:
                print("Error 19a2 - You have entered a unrecognizable value. Please enter only a function number.")
        ...
        while True:
            try:
                ...
                if roottype in ("s","S"):
                    ...
                    print("Error 67a - Please only enter 's' or 'c' to specify your choice.")
            except Exception:
